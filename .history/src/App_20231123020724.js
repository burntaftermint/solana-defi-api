...
function App() {
  ...
  <img src={process.env.PUBLIC_URL + '/burntaftermint.png'} alt="Logo" />
      ...
      {/* Main content */}
      <div className="NFTs">
        <h1>Top Defi Tokens</h1>
        <h3>This is a top list of Defi tokens in terms of volume over the last 24 hours. The list is generated using the Birdeye API and is updated daily.</h3>
