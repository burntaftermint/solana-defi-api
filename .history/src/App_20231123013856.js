...
function App() {
  ...
  // Function to convert decimals to Solana
  const convertDecimalsToSolana = (value, decimals) => {
          ...
          <ul className="NFT-list">
            {tokens.map((token, index) => (
              <li key={index}>
                ...
                <strong>Price in Solana:</strong> {convertDecimalsToSolana(token.v24hUSD, token.decimals)} SOL<br />
