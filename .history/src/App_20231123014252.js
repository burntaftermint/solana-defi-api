          ...
          <ul className="NFT-list">
            {tokens.map((token, index) => (
              <li key={index}>
                ...
                <strong>24h Change Percent:</strong> {token.v24hChangePercent.toFixed(3)}% <br />
                <strong>24h USD:</strong> {token.v24hUSD.toFixed(3)} <br />
                <strong>Price in USD:</strong> {convertDecimalsToUSD(token.v24hUSD, token.decimals)} USD<br />
